        ...
        <div class="col-lg-12">
            <div class="card box-shadow-0">
                <div class="card-body">
                    ...
                    {{-- Page-level metadata that applies to all translations. --}}
                        ...
                        <tbody>
                            ...
                            @forelse ($data->translations as $translation)
                                ...
                                <tr>
                                    ...
                                    <td dir="{{ $isRtl ? 'rtl' : 'ltr' }}" class="{{ $isRtl ? 'text-end' : 'text-start' }}">
                                        {{ $translation->page_title ?? 'N/A' }}
                                    </td>
                                    <td>
                                        <div dir="{{ $isRtl ? 'rtl' : 'ltr' }}"
                                            class="{{ $isRtl ? 'text-end' : 'text-start' }}">
                                            {!! $translation->page_content ?? 'N/A' !!}
                                        </div>
                                    </td>
                                </tr>
                            @empty
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('dynamic.edit', $data->id) }}" class="btn btn-primary">Edit</a>
