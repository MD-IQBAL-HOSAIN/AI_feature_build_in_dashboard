            ...
            <div class="card box-shadow-0">
                <div class="card-body">
                    <div class="alert alert-info">
                        Use the language tabs to enter one FAQ in multiple languages without making the page huge. Empty
                        tabs will be skipped automatically.
                    </div>

                    <form id="faq-form" action="{{ route('faq.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        @include('backend.v1.faqs._translation_tabs', ['languages' => $languages])
